...
public class LabirintoBuilder {
	...
	private Map<String, Stanza> attrezzo;

	public LabirintoBuilder() {
		this.labirinto = new Labirinto();
		this.attrezzo = new HashMap<String, Stanza>();
	}
	
	public Map<String, Stanza> getattrezzo() {
		return attrezzo;
	}
	...
	public LabirintoBuilder addStanzaIniziale(String stanzaIniziale) {
		...
		this.labirinto.setStanzaAttuale(i);
	...
	public LabirintoBuilder addStanzaVincente(String stanzaVincente) {
		...
		this.labirinto.setStanzaAttuale(s);
	...
	public LabirintoBuilder addAdiacenza(String stanzaCorrente, String stanzaAdiecente, String direzione) {
		Stanza c = this.attrezzo.get(stanzaCorrente);
		Stanza a = this.attrezzo.get(stanzaAdiecente);
	...
	public void UltimaStanzaAggiuntaEAggiorna(Stanza stanza) {
		...
		this.attrezzo.put(stanza.getNome(), stanza);
	}
}
